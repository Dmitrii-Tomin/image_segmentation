...
class Processing:
    ...
    def calculate_threshold(self, bw):
        ...
        print("Threshold calculated:", mean_threshold)
    ...
    def check(self, mean_threshold, max_threshold, first_layer_list, n):
        ...
        self.check(mean_threshold, max_threshold, first_layer_list, n + 1)
...
def main(depth, border_width, sigma):
    ...
    processed.check(mean_threshold, max_threshold, first_layer_list, n=0)
    ####################################################################################
